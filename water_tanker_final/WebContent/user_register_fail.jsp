...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium">
    ...
    <a  style="text-decoration: none;" href="register_proceess.jsp" class="w3-bar-item w3-button">Register</a>
...
<div class="w3-container w3-padding-64 w3-center w3-container w3-myfont" id="team">
    <h1 style="font-weight: bolder;"><p style="color: grey" class="w3-xxxlarge">You Are Not Registered Aadhar User.<br/> To Register Here Please Register For Aadhar Before Hand.</p></h1>
 </div>
 ...
 <div class="w3-col m8">
    ...
    <!--   <form class="w3-container w3-card-4 w3-padding-16 w3-white" >
      <div class="w3-section "> 
        ...
        <a href="register.jsp" style="float: left;margin-left: 15%"><button type="button" class="w3-button w3-right w3-theme">Customers</button> </a>
        
        <a href="register_supplier.jsp" style="float: right;margin-right: 20%"><button type="button" class="w3-button w3-right w3-theme">Suppliers</button> </a>
          </div>
      </form> -->
