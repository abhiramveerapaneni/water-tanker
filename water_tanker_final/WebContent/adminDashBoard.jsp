...
<div class="w3-container w3-padding-64 w3-center w3-container w3-myfont" id="team">
    <h1 style="font-weight: bolder;"><p style="color: grey" class="w3-xxxlarge"><font style="color: darijkorange">Select any option</font></p></h1>
 </div>
...
<div style="visibility: hidden; ">@fff-jfff i_+</div> 
 ...
 <div class="w3-col m8">
      ...
      <div class="w3-section "> 
        ...
        <a href="<%=request.getContextPath()%>/AdminController?action=userData" style="float: left;margin-left: 3%"><button type="button" class="w3-button w3-right w3-theme">Customer data</button> </a>
        
        <a href="<%=request.getContextPath()%>/AdminController?action=AnalyseData" style="float: left;margin-left: 10%"><button type="button" class="w3-button w3-right w3-theme">Analyse Data</button> </a>
        
        <a href="<%=request.getContextPath()%>/AdminController?action=resetCount" style="float: left;margin-left: 10%"><button type="button" class="w3-button w3-right w3-theme">Reset Government count</button> </a>
        
        <a href="<%=request.getContextPath()%>/AdminController?action=supplierData" style="float: right;margin-right: 5%"><button type="button" class="w3-button w3-right w3-theme">Supplier data</button> </a>
          </div>
      </form>
    </div>
