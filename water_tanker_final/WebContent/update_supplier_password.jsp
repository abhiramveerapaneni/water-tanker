...
<div style="visibility: hidden; ">@fff-jfff i_+</div> 
 ...
 <div class="w3-col m8">
      ...
      <div class="w3-section">      
       ...
       <div class="w3-section">      
        <label>Company License <font color="red">*</font></label>
        <input class="w3-input" type="text" name="company_license" placeholder="Enter Company License " required>
      </div>
      <div class="w3-section">      
        <label>Password <font color="red">*</font></label>
        <input class="w3-input" type="password" name="company_password" placeholder="Enter New Password" required="required">
      </div>
      <div class="w3-section">      
        <label>Confirm Password <font color="red">*</font></label>
        <input class="w3-input" type="password" name="cpassword" placeholder="Confirm your New Password" required="required">
      </div>
     ...
     <div class="container">
      ...
      <input type="hidden" name="action" value="update_supplier_password">
