...
<input type="text" name="c_name" value="<%=c_name%>"  hidden>
    <h1 style="font-weight: bolder;"><p style="color: grey" class="w3-xxxlarge">Action Updated Successfully 
    <br>Click 
    <input type="hidden" name="action" value="Temporary">
      <button type="submit" class="w3-button  w3-theme">Here</button>
    
    To See Other Requests</p></h1>
 </form>
 </div>
