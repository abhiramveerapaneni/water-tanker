...
<div class="w3-container w3-padding-64 w3-center w3-container w3-myfont" id="team">
    <h1 style="font-weight: bolder;"><p style="color: grey" class="w3-xxxlarge"><font style="color: darijkorange">Select category To Login</font></p></h1>
 </div>
...
<div style="visibility: hidden; ">@fff-jfff i_+</div> 
 ...
 <div class="w3-col m8">
      ...
      <div class="w3-section "> 
        ...
        <a href="login_user.jsp" style="float: left;margin-left: 15%"><button type="button" class="w3-button w3-right w3-theme">Customers</button> </a>
        
        <a href="login_supply.jsp" style="float: right;margin-right: 20%"><button type="button" class="w3-button w3-right w3-theme">Suppliers</button> </a>
          </div>
      </form>
    </div>
