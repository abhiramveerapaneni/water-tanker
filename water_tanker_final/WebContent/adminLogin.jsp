...
<h1 style="font-weight: bolder;"><p class="w3-xxxlarge">Admin Log In</p></h1>
 </div>
...
<div style="visibility: hidden; ">@fff-jfff i_+</div> 
 ...
 <div class="w3-col m8">
      ...
      <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="AdminController" method="post">
      <div class="w3-section">      
        <label>Admin User Name <font color="red">*</font></label>
        <input class="w3-input" type="text" name="admin_name" placeholder="enter admin name" required>
      </div>
      <div class="w3-section">      
        <label>Password <font color="red">*</font></label>
        <input class="w3-input" type="password" name="admin_password"  placeholder="enter your password" required>
      </div>
