...
<h1 style="font-weight: bolder;"><p class="w3-xxxlarge">Supplier Log In</p></h1>
 </div>
...
<div style="visibility: hidden; ">@fff-jfff i_+</div> 
 ...
 <div class="w3-col m8">
      ...
      <div class="w3-section">      
        ...
        <input class="w3-input" type="password" name="company_password" placeholder="Enter Password" required="required">
      </div>
     ...
     <div class="container">
      ...
      <div> <a href="<%=request.getContextPath()%>/SupplierController?action=updateSupplierPassword" class="w3-input" style="border: none; width: 150px;padding: 15px;">Forgot Password ?</a></div>
    
      <input type="hidden" name="action" value="supplier_login">
      <button type="submit" class="w3-button w3-right w3-theme">Log In</button>
      </form>
    </div>
