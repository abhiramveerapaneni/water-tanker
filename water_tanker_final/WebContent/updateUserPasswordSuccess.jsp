...
<div class="w3-container w3-padding-64 w3-center w3-container w3-myfont" id="team">
    <h1 style="font-weight: bolder;"><font style="color: grey" class="w3-xxxlarge">Password Updated Successfully <br>Click <a href="login_process.jsp">Here</a> To Login</font></h1>
 </div>
