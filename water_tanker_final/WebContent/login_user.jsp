...
<div id="id01" class="w3-modal">
  <div class="w3-modal-content w3-card-4 w3-animate-top">
    ...
    <div class="w3-container">
      <p>water rare? Ok, water water water..</p>
      <p>Go to our <a class="w3-text-teal" href="#">water</a> to learn more!</p>
    </div>
...
<h1 style="font-weight: bolder;"><p class="w3-xxxlarge">Customer Log In</p></h1>
 </div>
...
<div style="visibility: hidden; ">@fff-jfff i_+</div> 
 ...
 <div class="w3-col m8">
      ...
      <div class="w3-section">      
        ...
        <input class="w3-input" type="text" name="user_aadhar" placeholder="enter aadhar number" required>
      </div>
      <div class="w3-section">      
        <label>Password <font color="red">*</font></label>
        <input class="w3-input" type="password" name="user_password"  placeholder="enter your password" required>
      </div>
     ...
     <div class="container">
      ...
      <div> <a href="<%=request.getContextPath()%>/UserController?action=updatePassword" class="w3-input" style="border: none; width: 150px;padding: 15px;">Forgot Password ?</a></div>
