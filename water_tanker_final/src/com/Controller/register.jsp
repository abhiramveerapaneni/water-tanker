...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a style="float: right;text-decoration: none;" href="#team" class="w3-bar-item w3-button w3-hide-small w3-hover-white ">Contact Us</a>
  <a style="float: right;text-decoration: none;" href="#work" class="w3-bar-item w3-button w3-hide-small w3-hover-white">About Us</a>
  <a style="float: right;text-decoration: none;" href="#pricing" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Price</a>
  <a style="float: right;text-decoration: none;" href="register_process.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Register</a>
  <a style="float: right;text-decoration: none;" href="login_process.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Login</a>
...
<!--     <div class="w3-dropdown-hover w3-hide-small">
 ...
 -->
  ...
  <div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium">
    <a  style="text-decoration: none;"href="#team" class="w3-bar-item w3-button">About Us</a>
    <a  style="text-decoration: none;" href="#work" class="w3-bar-item w3-button">Price</a>
    <a  style="text-decoration: none;" href="login_process.html" class="w3-bar-item w3-button">Login</a>
    <a  style="text-decoration: none;" href="register_process.html" class="w3-bar-item w3-button">Register</a>
...
<!-- <div class="w3-display-container w3-animate-opacity">
  <img src="pp.jpg" alt="boat" style="width:100%;min-height:350px;max-height:600px;">
...
<h1 style="font-weight: bolder;"><p class="w3-xxxlarge">Register Here</p></h1>
 </div>
...
<div class="w3-col m2">
<div style="visibility: hidden; ">fffffffff</div> 
    </div>
    
 <div class="w3-col m8">
     
      <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="NavigationController" method="get" >
      <!-- <div class="w3-section">      
        <label> Name <font color="red">*</font></label>
        <input class="w3-input" type="text" name="Name" placeholder="Enter your name" required>
      </div>
      
      <div class="w3-section">      
        <label>Email <font color="red">*</font></label>
        <input class="w3-input" type="email" name="mail" placeholder="Enter your valid email id" required>
      </div> -->
      
       <div class="w3-section">      
        <label>Aadhar Number <font color="red">*</font></label>
        <input class="w3-input" type="text" name="aadhar" placeholder="Enter your Aadhar Number" required>
      </div>
      
      <div class="w3-section">      
        <label>Password <font color="red">*</font></label>
        <input class="w3-input" type="password" name="password" placeholder="Enter your new password" required>
      </div>
      
      <div class="w3-section">      
        <label>Confirm Password <font color="red">*</font></label>
        <input class="w3-input" type="password" name="password1" placeholder="Confirm your new password" required>
      </div>
      ...
      <!-- <div class="w3-section">      
        ...
        <input  class="w3-input" type="radio" name="radio"  required>Male
         <input  class="w3-input" type="radio" name="radio"  required>Female
     
      </div>
      
       <div class="w3-section">      
        <label>Phone number <font color="red">*</font></label>
        <input class="w3-input" type="text" name="phone" placeholder="Enter your mobile number" required>
      </div>
     ...
     <input type="hidden"  name="action" value="user_register">
      <input type="submit" class="w3-button w3-right w3-theme" value="Register">
